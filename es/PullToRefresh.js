...
var PullToRefresh = function (_React$Component2) {
    ...
    function PullToRefresh() {
        ...
        _this2.init = function (ele) {
			...
			if(_this2.props.enableMouse){
				_this2._to = {
					mousedown: _this2.onMouseDown.bind(_this2, ele),
					mousemove: _this2.onMouseMove.bind(_this2, ele),
					mouseup: _this2.onMouseUp.bind(_this2, ele),
					mouseup: _this2.onMouseUp.bind(_this2, ele),
        ...
        _this2.onMouseDown = function (_ele, e) {
			_this2.state.mouseDown=true;
            _this2._ScreenY = _this2._startScreenY = e.pageY;
            // 一开始 refreshing 为 true 时 this._lastScreenY 有值
            _this2._lastScreenY = _this2._lastScreenY || 0;
			
			_this2._ScreenX = _this2._startScreenX = e.pageX;
        ...
        _this2.onMouseMove = function (ele, e) {
            // 使用 pageY 对比有问题
			if (!(_this2.state.mouseDown&&!_this2.state.mouseUp)){return _this2.onMouseUp();}
            var _screenY = e.pageY;
			var _screenX = e.pageX;
            var direction = _this2.props.direction;
            // 拖动方向不符合的不处理
			...
			if (Math.abs(_this2._startScreenY - _screenY) < Math.abs(_this2._startScreenX - _screenX)) {
				if (!_this2.state.directionY){
					return _this2.onMouseUp();
				}
            }
			_this2.state.directionY = true;
        ...
        _this2.onMouseUp = function () {
			_this2.state.mouseUp=false;
			_this2.state.mouseDown=false;
			_this2.state.directionY = false;
